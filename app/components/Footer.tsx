    ...
    <footer className="border-t border-blue-100 bg-blue-50/40">
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        <div className="flex flex-col gap-10 md:flex-row md:justify-between">
          ...
          <div>
            <p className="text-sm font-semibold uppercase tracking-wide text-slate-500">On this page</p>
            <ul className="mt-3 grid gap-2 sm:grid-cols-2">
              {NAV_LINKS.map((link) => (
                <li key={link.href}>
                  <a href={link.href} className="text-sm text-blue-700 hover:underline">
                    {link.label}
                  </a>
                </li>
              ))}
        ...
        <p className="mt-10 border-t border-blue-100 pt-8 text-center text-sm text-slate-500">
