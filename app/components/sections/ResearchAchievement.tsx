...
export function ResearchAchievement() {
  return (
    <section id="research-achievement" className="scroll-mt-20 border-b border-blue-100 bg-blue-50/30">
      <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
        <div className="max-w-2xl">
          <h2 className="text-3xl font-semibold tracking-tight text-slate-900">Research achievement</h2>
          <p className="mt-3 text-slate-600">
            Showcase measurable outcomes: papers, systems, datasets, or impact. Edit the cards below with your
            results.
          </p>
        </div>
        ...
        <ul className="mt-12 grid gap-6 lg:grid-cols-3">
          {ACHIEVEMENTS.map((a) => (
            <li key={a.title} className="rounded-2xl border border-blue-100 bg-white p-6 shadow-sm">
